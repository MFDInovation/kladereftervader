...
class WeatherAnimation{
    ...
    func create(in view:UIView, for weather:Weather){
        ...
        case .Rain, .Rainshowers:
            create(in: view, intensity: Int(min(weather.rainfall*10, 100.0)), wind: windSpeed, particle: #imageLiteral(resourceName: "rain"), time: 0.4)
        case .Snowfall, .Snowshowers:
            create(in: view, intensity: Int(min(weather.rainfall*20, 200.0)), wind: windSpeed, particle: #imageLiteral(resourceName: "snow"), time: 6)
        case .Sleet, .Lightsleet:
            create(in: view, intensity: Int(min(weather.rainfall*5, 50.0)), wind: windSpeed, particle: #imageLiteral(resourceName: "rain"), time: 0.4)
            create(in: view, intensity: Int(min(weather.rainfall*10, 100.0)), wind: windSpeed, particle: #imageLiteral(resourceName: "snow"), time: 6)
        ...
        default:
                ...
                create(in: view, intensity: Int(min(weather.rainfall*15, 100.0)), wind: windSpeed, particle: particle, time: Double(time))
